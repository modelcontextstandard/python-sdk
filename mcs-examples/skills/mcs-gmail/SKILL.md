...
```bash
pip install mcs-driver-mail>=0.1.4 mcs-driver-core>=0.3.0 mcs-driver-mailread>=0.2.2 mcs-driver-mailsend>=0.2.2 mcs-adapter-http>=0.3.0 mcs-auth>=0.3.1 mcs-auth-auth0>=0.4.2 mcs-auth-linkauth>=0.4.2 mcs-types-cache>=0.1.1
```
